...
const LayoffModal: React.FC = () => {
  const {
    ...
    signGoodbyeLetter,
    feelLucky,
    openMiseryModal // Assume this is provided by context
  } = useCalendar();
    ...
    <div className="fixed inset-0 flex items-center justify-center modal-overlay z-50">
      <div className="modal-content p-6 relative max-w-lg w-full">
        ...
        <div className="text-center mb-6 mt-2">
          <h2 className="text-center text-[#82b1ff] font-bold text-2xl">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg mb-6">
            {currentEmployee.id <= 4 ? (
              ...
              "Don't tempt fate...toss a coin now!"
            )}
          </p>
          ...
          <div className="space-y-4">
            <button
              onClick={currentEmployee && currentEmployee.id <= 4 ? bidOnPTO : feelLucky}
            ...
            <button
              onClick={currentEmployee && currentEmployee.id <= 4 ? signGoodbyeLetter : openMiseryModal}
